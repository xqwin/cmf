...
<nav class="layout-navbar navbar navbar-expand-lg align-items-lg-center container-p-x bg-primary-dark navbar-dark" id="layout-navbar">
    ...
    <a href="index.html" class="navbar-brand app-brand demo d-lg-none py-0 mr-4">
        ...
        <span class="app-brand-text demo font-weight-normal ml-2">{config('xqwin.cmf.site')}</span>
    </a>
        ...
        <div class="navbar-nav align-items-lg-center ml-auto">
            <div class="demo-navbar-notifications nav-item dropdown mr-lg-3">
                <a class="nav-link dropdown-toggle hide-arrow" href="#" data-toggle="dropdown">
                    <i class="fa fa-bell navbar-icon align-middle"></i>
            ...
            <div class="demo-navbar-messages nav-item dropdown mr-lg-3">
                <a class="nav-link dropdown-toggle hide-arrow" href="#" data-toggle="dropdown">
                    <i class="fa fa-envelope-o navbar-icon align-middle"></i>
                    <span class="badge badge-primary badge-dot indicator"></span>
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <div class="list-group list-group-flush">
                        <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                            <img src="/static/images/6-small.png" class="d-block ui-w-40 rounded-circle" alt="">
                        ...
                        <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                            <img src="/static/images/4-small.png" class="d-block ui-w-40 rounded-circle" alt="">
                            <div class="media-body ml-3">
                        ...
                        <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                            <img src="/static/images/5-small.png" class="d-block ui-w-40 rounded-circle" alt="">
                            <div class="media-body ml-3">
                                <div class="text-body line-height-condenced">Sit meis deleniti eu, pri vidit meliore docendi ut.</div>
                                <div class="text-light small mt-1">
                        ...
                        <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                            <img src="/static/images/11-small.png" class="d-block ui-w-40 rounded-circle" alt="">
                            <div class="media-body ml-3">
            ...
            <div class="cmf-navbar-user nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                  <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                    <img src="/static/images/avatar.jpg " alt="" class="d-block ui-w-30 rounded-circle">
                    <span class="px-1 mr-lg-2 ml-2 ml-lg-0">test@test.com</span>
                  </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="javascript:void(0)" class="dropdown-item"><i class="fa fa-user text-lightest"></i>网站信息</a>
                    <a href="javascript:void(0)" class="dropdown-item"><i class="fa fa-envelope text-lightest"></i>个人资料</a>
                    <a href="javascript:void(0)" class="dropdown-item"><i class="fa fa-gear text-lightest"></i>修改密码</a>
                    <div class="dropdown-divider"></div>
                    <a href="javascript:void(0)" class="dropdown-item"><i class="fa fa-sign-out text-danger"></i>退出登陆</a>
                </div>
            </div>
        </div>
    </div>
